...
ADD COLUMN formapag VARCHAR(45);
...
UPDATE salaosenac.tbl_registroServico
SET formapag = 'PIX'
WHERE idtbl_registroServico IN (4, 7, 10, 15, 18, 20);
...
(2, 2, 30.00, 30.00, 0.00, 'Manicure com esmalte da cliente', 'Concluído', 1),
(3, 3, 70.00, 70.00, 0.00, 'Hidratação profunda para cabelo seco', 'Concluído', 1),
(4, 4, 50.00, 50.00, 0.00, 'Corte de cabelo e secagem', 'Concluído', 1),
(5, 5, 25.00, 25.00, 0.00, 'Pedicure simples', 'Concluído', 1),
(6, 6, 50.00, 50.00, 0.00, 'Corte de cabelo e hidratação', 'Concluído', 1),
(7, 7, 50.00, 50.00, 0.00, 'Corte de cabelo masculino', 'Concluído', 1),
(8, 8, 30.00, 30.00, 0.00, 'Manicure com esmalte da cliente', 'Concluído', 1),
(9, 9, 60.00, 60.00, 0.00, 'Hidratação capilar com máscara profissional', 'Concluído', 1),
...
(12, 12, 35.00, 35.00, 0.00, 'Manicure com esmalte especial', 'Concluído', 1),
(13, 13, 70.00, 70.00, 0.00, 'Hidratação capilar e corte', 'Concluído', 1),
(14, 14, 50.00, 50.00, 0.00, 'Corte de cabelo e escova', 'Concluído', 1),
(15, 15, 25.00, 25.00, 0.00, 'Pedicure simples', 'Concluído', 1),
(16, 16, 50.00, 50.00, 0.00, 'Corte de cabelo e hidratação', 'Concluído', 1),
(17, 17, 30.00, 30.00, 0.00, 'Manicure simples', 'Concluído', 1),
(18, 18, 60.00, 60.00, 0.00, 'Hidratação capilar e finalização', 'Concluído', 1),
